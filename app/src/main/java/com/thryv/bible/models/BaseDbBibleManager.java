...
public class BaseDbBibleManager extends BibleManager {
    ...
    private static final String BOOK_ABBREVIATION = "short_name";
    private static final String BOOK_NUMBER = "book_number";

    public BaseDbBibleManager(Context context){
    ...
    public List<Book> getBooks(){
        ...
        String queryString = "SELECT " + BOOK_NUMBER + "," + BOOK_NAME + "," + BOOK_ABBREVIATION + " FROM " + BOOK_TABLE + " ORDER BY " + BOOK_NUMBER;
        ...
        while (!queryCursor.isAfterLast()) {
            ...
            book.setAbbreviation(queryCursor.getString(queryCursor.getColumnIndex(BOOK_ABBREVIATION)));
            books.add(book);
